...
def baseline_fgsm_against_vat(train_start=0, train_end=60000, test_start=0,
    ...
    if clean_train:
        ...
        # Initialize the FGSM attack object and graph
    ...
    #
    # let's generate VAT examples (explicitly include some defaults here)
    #
    vat_params = {'eps': 2.0,
                  'num_iterations': 1,
                  'xi': 1e-6,
    ...
    preds_2_vat = model_2(adv_x_vat)

    # DON'T WANT TO TRAIN on VAT adv examples yet, TBD in combined model
    ...
    def evaluate_2():
        ...
        # Accuracy of the FGSM adv trained model on VAT adv examples
        accuracy = model_eval(sess, x, y, preds_2_vat, X_test,
                              Y_test, args=eval_params)
...
def main(argv=None):
    baseline_fgsm_against_vat(nb_epochs=FLAGS.nb_epochs, batch_size=FLAGS.batch_size,
