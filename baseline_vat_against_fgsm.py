...
def baseline_virtual_adversarial(train_start=0, train_end=60000, test_start=0,
    ...
    if clean_train:
        ...
        # Initialize the Virtual Adversarial Method (VAT) attack object and graph
    ...
    adv_x_2 = vat2.generate(x, **vat_params)
    ...
    def evaluate_2():
        ...
        # Accuracy of the VAT adv trained model on VAT adv examples
        eval_params = {'batch_size': batch_size}
...
def main(argv=None):
    baseline_virtual_adversarial(nb_epochs=FLAGS.nb_epochs, batch_size=FLAGS.batch_size,
