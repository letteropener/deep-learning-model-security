...
def mnist_tutorial(train_start=0, train_end=60000, test_start=0,
    ...
    if clean_train:
        ...
        ###############################################################
        # Init the CW Method attack object and graph
        ...
        cw_params = {'binary_search_steps': 1,
             ...
             'batch_size': source_samples,
             'initial_const': 10}
        adv_x_3 = cw.generate(x, **cw_params)
        preds_adv_3 = model.get_probs(adv_x_3)
        cw_eval_params = {'batch_size': source_samples}
        # Evaluate the accuracy of the MNIST model on EN adversarial examples
        acc = model_eval(sess, x, y, preds_adv_3, X_test, Y_test, args=cw_eval_params)
    ...
    ##########################################
    cw2 = CarliniWagnerL2(model_2, back='tf',sess=sess)
    ...
    cw_params = {'binary_search_steps': 1,
         ...
         'batch_size': source_samples,
         'initial_const': 10}
    adv_x_cw = cw2.generate(x, **cw_params)
    
    preds_2_adv_cw = model_2(adv_x_cw)
    ...
    def evaluate_2():
        ...
        cw_eval_params = {'batch_size': source_samples}
        accuracy = model_eval(sess, x, y, preds_2_adv_cw, X_test,
                              Y_test, args=cw_eval_params)
        print('Test accuracy on CW adversarial examples: %0.4f' % accuracy)
